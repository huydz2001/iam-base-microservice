...
export class CreateTableMigration1722932068361 implements MigrationInterface {
    name = 'CreateTableMigration1722932068361'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."permisions_type_enum" AS ENUM('1', '2', '3', '4')`);
        await queryRunner.query(`CREATE TABLE "permisions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, "created_by" character varying NOT NULL, "updated_by" character varying NOT NULL, "is_deleted" boolean NOT NULL, "deleted_by" character varying, "type" "public"."permisions_type_enum" NOT NULL, "desc" character varying NOT NULL, "module_id" uuid, CONSTRAINT "PK_496458b9ce3a297e65ac3333f7f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_496458b9ce3a297e65ac3333f7" ON "permisions" ("id") `);
        await queryRunner.query(`CREATE INDEX "idx_permission" ON "permisions" ("module_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7dbefd488bd96c5bf31f0ce0c9" ON "modules" ("id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_3001e89ada36263dabf1fb6210" ON "tokens" ("id") `);
        await queryRunner.query(`CREATE INDEX "idx_loginToken_refreshToken" ON "tokens" ("refresh_token") `);
        await queryRunner.query(`CREATE INDEX "idx_loginToken_accessToken" ON "tokens" ("access_Token") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_loginToken_uId" ON "tokens" ("user_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_8e520eb4da7dc01d0e190447c8" ON "profiles" ("id") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_profile_userName" ON "profiles" ("user_name") `);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('1', '2', '0')`);
        ...
        await queryRunner.query(`CREATE TABLE "groups_modules" ("group_id" uuid NOT NULL, "module_id" uuid NOT NULL, CONSTRAINT "PK_c7724aa8bce1da4f4b196ad3ca7" PRIMARY KEY ("group_id", "module_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_495104682d0031fd759d2a15d3" ON "groups_modules" ("group_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_54917bb77799cf01748c912a2b" ON "groups_modules" ("module_id") `);
        await queryRunner.query(`ALTER TABLE "permisions" ADD CONSTRAINT "FK_005d2c64c2265fb090df71798cd" FOREIGN KEY ("module_id") REFERENCES "modules"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "groups_modules" ADD CONSTRAINT "FK_495104682d0031fd759d2a15d30" FOREIGN KEY ("group_id") REFERENCES "groups"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "groups_modules" ADD CONSTRAINT "FK_54917bb77799cf01748c912a2bb" FOREIGN KEY ("module_id") REFERENCES "modules"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "groups_modules" DROP CONSTRAINT "FK_54917bb77799cf01748c912a2bb"`);
        await queryRunner.query(`ALTER TABLE "groups_modules" DROP CONSTRAINT "FK_495104682d0031fd759d2a15d30"`);
        ...
        await queryRunner.query(`ALTER TABLE "permisions" DROP CONSTRAINT "FK_005d2c64c2265fb090df71798cd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_54917bb77799cf01748c912a2b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_495104682d0031fd759d2a15d3"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8e520eb4da7dc01d0e190447c8"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_loginToken_refreshToken"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3001e89ada36263dabf1fb6210"`);
        await queryRunner.query(`DROP TABLE "tokens"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_659d1483316afb28afd3a90646"`);
        await queryRunner.query(`DROP TABLE "groups"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7dbefd488bd96c5bf31f0ce0c9"`);
        await queryRunner.query(`DROP TABLE "modules"`);
        await queryRunner.query(`DROP INDEX "public"."idx_permission"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_496458b9ce3a297e65ac3333f7"`);
