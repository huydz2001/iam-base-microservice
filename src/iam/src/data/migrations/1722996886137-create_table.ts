...
export class CreateTable1722996886137 implements MigrationInterface {
    name = 'CreateTable1722996886137'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "idx_group_name" ON "groups" ("name") `);
        ...
        await queryRunner.query(`CREATE TABLE "groups_permissions" ("group_id" uuid NOT NULL, "permission_id" uuid NOT NULL, CONSTRAINT "PK_c528fc87b92c80b06e44399c66c" PRIMARY KEY ("group_id", "permission_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "groups_permissions" ADD CONSTRAINT "FK_b5d3ffb9a81999715eaa4fe07bc" FOREIGN KEY ("group_id") REFERENCES "groups"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_47bf6007bfde3928fc923ee3d5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b5d3ffb9a81999715eaa4fe07b"`);
