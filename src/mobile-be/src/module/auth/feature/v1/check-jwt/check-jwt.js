...
const handle_error_rpc_1 = require("building-blocks/utils/handle-error-rpc");
let CheckJwtHandler = CheckJwtHandler_1 = class CheckJwtHandler {
    ...
    async checkJwtGuard(command) {
        ...
        try {
            ...
            if (((_a = resp === null || resp === void 0 ? void 0 : resp.data) === null || _a === void 0 ? void 0 : _a.message) !== undefined) {
                const response = new handle_error_rpc_1.ReponseDto({
                    name: resp === null || resp === void 0 ? void 0 : resp.data.name,
                    message: resp === null || resp === void 0 ? void 0 : resp.data.message,
                });
                (0, handle_error_rpc_1.handleRpcError)(response);
            }
            else {
    ...
    async checkAdminGuard(command) {
        var _a, _b;
        try {
            const resp = await this.amqpConnection.request({
                exchange: configs_1.default.rabbitmq.exchange,
                routingKey: rabbitmq_constant_1.RoutingKey.MOBILE_BE.CHECK_ADMIN_GUARD,
                payload: command,
                timeout: 10000,
            });
            if (((_a = resp === null || resp === void 0 ? void 0 : resp.data) === null || _a === void 0 ? void 0 : _a.message) !== undefined) {
